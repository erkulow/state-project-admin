...
import DetailCleanlines from './DetailCleanlines'

const CleanlinesList = ({ item }) => {
   ...
   return (
      <>
         ...
         <ModalDelete
            ...
            action={() =>
               dispatch(deleteData({ id: item.id, category: 'cleanliness' }))
            }
