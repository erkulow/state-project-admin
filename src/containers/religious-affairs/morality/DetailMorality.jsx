...
const DetailMorality = ({ data, setShowDeleteModal, editHandler }) => {
      ...
      <div>
         <Flex gap="30px" align="start">
            <Flex direction="column" align="center" width="50%" gap="10px">
               ...
               <TitlePosition size="20px">Адеп ахлак</TitlePosition>
            </Flex>
            <Flex width="100%" justify="center" direction="column" gap="30px">
               <List>
                  <Li>
                     <b>Адеп ахлак жонундо маалымат:</b> <span ref={refText} />
                  </Li>
               </List>
