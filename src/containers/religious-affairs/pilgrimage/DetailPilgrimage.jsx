...
const DetailPilgrimage = ({ data, setShowDeleteModal, editHandler }) => {
      ...
      <div>
         <Flex gap="30px" align="start">
            ...
            <Flex width="100%" justify="center" direction="column" gap="30px">
               <List>
                  <H2>Ажылык жонундо маалымат</H2>
                  <Li>
                     <b>Ажынын аты-жону:</b> {data.fullName}
                  </Li>
                  <Li>
                     <b>Ажылык жонундо маалымат:</b> <span ref={refText} />
                  </Li>
               </List>
...
export default DetailPilgrimage
