...
const Kingergartens = React.lazy(() => import('../containers/education/kingergartens'))
...
const Mosques = React.lazy(()=>import('../containers/religious-affairs/mosques'))
const Madrasa = React.lazy(()=>import('../containers/religious-affairs/madrasas'))
const Pilgrimage = React.lazy(()=>import('../containers/religious-affairs/pilgrimage'))
const Ait = React.lazy(()=>import('../containers/religious-affairs/ait'))
const Morality = React.lazy(()=>import('../containers/religious-affairs/morality'))
      ...
      <Routes>
         ...
         <Route element={<ProtectedRoute isAllowed={isAuthorized} />}>
            ...
            <Route  element={<TemplateLeaderShipPages />}>
               ...
               <Route path={healthCare.paramedicPoint.path} element={<FAPs />}/>
               <Route path={healthCare.OMS.path} element={<OMS />} />
               <Route path={healthCare.doctorAdvice.path} element={<DoctorsAdvice />}/>
               <Route path={healthCare.OMS.path} element={<OMS />} /> 

               <Route path={religiousAffairs.mosques.path} element={<Mosques/>} />   
               <Route path={religiousAffairs.madrasas.path} element={<Madrasa/>} />  
               <Route path={religiousAffairs.ait.path} element={<Ait/>} />  
               <Route path={religiousAffairs.morality.path} element={<Morality/>} />  
               <Route path={religiousAffairs.pilgrimage.path} element={<Pilgrimage/>} />  
               <Route path={religiousAffairs.namaz.path} element={<Namaz/>} />  
               <Route path={religiousAffairs.ramadan.path} element={<Ramadan/>} />  
